...
class LSTheme {
  ...
  static final ThemeData mainTheme = ThemeData(
    ...
    textTheme: ThemeData.light().textTheme.copyWith(
          headline1: const TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: lastSearchRed),
          headline2: const TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: lastSearchDark),
          headline3: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: lastSearchDark),
